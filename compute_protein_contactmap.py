...
def compute_contact_map(file_name):
    ...
    try:
        path_share = '/home/xxyu/pocketminer/bindingDB/AF2_prot/'
    ...
    edge_index = torch.save(edge_index, '/home/xxyu/DTI_predict/our_code/data/bindingDB/protein_info2/contact_map_2/' + str(file_name) + '.pt')
    return 1



folder_path = '/home/xxyu/pocketminer/bindingDB/AF2_prot'
